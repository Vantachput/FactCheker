...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE, user_states):
    ...
    start_text = (
        ...
        "Я допоможу вам розпізнати маніпуляції та перевірити новини на достовірність.\n\n"
        "🔍 **Як працювати з ботом:**\n"
        "1. Натисніть кнопку **'Класифікувати новину'**.\n"
        "2. Надішліть текст новини або заголовок.\n"
        "3. Отримайте вердикт на основі обраного методу.\n\n"
